...
# نسخه 3.0.0 - رفع خطای Heredoc/ARG_MAX با استفاده از Pipe
#=================================================================================
...
# ===== شروع تغییرات کلیدی (V3) =====
# ما از 'EOF_OUTER' (با کوت) استفاده می‌کنیم تا هیچ متغیری توسط پوسته بیرونی (Termux) پردازش نشود
# و اسکریپت به صورت خام به cat داخلی دبیان پایپ شود.
# تمام بک‌اسلش‌های فرار (escaping) از داخل اسکریپت حذف شده‌اند.
